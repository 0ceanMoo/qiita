...
tags:
  ...
  - tailscale
private: false
updated_at: '2026-07-02T14:42:48+09:00'
...
![NICの電源の管理設定](https://raw.githubusercontent.com/0ceanMoo/myBlog/main/images/tailscale-wol-rdp/nic-power-management.png)

続いて「詳細設定」タブを開き、プロパティ一覧から **「ウェイク・オン・マジック・パケット」** を選択して、値を **「有効」** に設定します。

<!-- 📸 NICプロパティの「詳細設定」タブ。「ウェイク・オン・マジック・パケット」を選択し、値が「有効」になっている状態 -->
![ウェイク・オン・マジック・パケットの設定](https://raw.githubusercontent.com/0ceanMoo/myBlog/main/images/tailscale-wol-rdp/nic-wake-on-magic-packet.png)
...
![リモートデスクトップの有効化](https://raw.githubusercontent.com/0ceanMoo/myBlog/main/images/tailscale-wol-rdp/windows-rdp-enable.png)
...
![MACアドレスの確認](https://raw.githubusercontent.com/0ceanMoo/myBlog/main/images/tailscale-wol-rdp/windows-mac-address.png)
...
![Windows App](https://raw.githubusercontent.com/0ceanMoo/myBlog/main/images/tailscale-wol-rdp/app-store-rdp.png)
...
![wakeコマンドの実行](https://raw.githubusercontent.com/0ceanMoo/myBlog/main/images/tailscale-wol-rdp/terminal-wake-command.png)

3. しばらく待ってWindowsが起動したら、Windows Appから接続する
4. 接続先にWindowsのローカルIPアドレスを指定する

<!-- 📸 Windows AppにWindowsのIPアドレスを入力している画面 -->
![RDP接続設定](https://raw.githubusercontent.com/0ceanMoo/myBlog/main/images/tailscale-wol-rdp/rdp-connection-setup.png)

<!-- 📸 RDPでWindowsのデスクトップに接続できた状態 -->
![RDP接続成功](https://raw.githubusercontent.com/0ceanMoo/myBlog/main/images/tailscale-wol-rdp/rdp-connected.png)
...
![Tailscale管理画面](https://raw.githubusercontent.com/0ceanMoo/myBlog/main/images/tailscale-wol-rdp/tailscale-admin.png)
...
![Tailscaleサービスの確認](https://raw.githubusercontent.com/0ceanMoo/myBlog/main/images/tailscale-wol-rdp/windows-tailscale-service.png)
...
![MacBook ProのTailscale接続確認](https://raw.githubusercontent.com/0ceanMoo/myBlog/main/images/tailscale-wol-rdp/macbook-tailscale-connected.png)
...
![外出先からRDP接続成功](https://raw.githubusercontent.com/0ceanMoo/myBlog/main/images/tailscale-wol-rdp/rdp-connected-remote.png)
